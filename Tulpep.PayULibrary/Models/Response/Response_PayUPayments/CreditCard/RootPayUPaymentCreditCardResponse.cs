...
namespace Tulpep.PayULibrary.Models.Response.Response_PayUPayments.CreditCard
{
    public class RootPayUPaymentCreditCardResponse
    {
        ...
        //The response’s data.
        public Response_CreditCard_TransactionResponse transactionResponse { get; set; }
    }
}
