...
namespace Tulpep.PayULibrary.Models.Request.Request_PayUPayments.Cash
{
    public class Request_Cash_Order
    {
        //Format: Numeric
        ...
        public Request_AdditionalValues additionalValues { get; set; }
        public Request_Cash_Buyer buyer { get; set; }
    }
}
