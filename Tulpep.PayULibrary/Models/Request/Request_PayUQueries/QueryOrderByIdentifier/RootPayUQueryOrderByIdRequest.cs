...
namespace Tulpep.PayULibrary.Models.Request.Request_PayUQueries.QueryOrderByIdentifier
{
    public class RootPayUQueryOrderByIdRequest
    {
        //Format: Boolean Size: 
        ...
        public Request_QueryOrderByIdentifier_Details details { get; set; }
    }
}
